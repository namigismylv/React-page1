import "./service_aboutMe_innovation.css";
function Service_aboutMe_innovation() {
  return (
    <>
      <section id="service">
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <div className="service__div__title">
                  <h5>MY SERVICE</h5>
                  <h2>
              ...
              <div className="col-4">
                <div className="field">
                  ...
                  <p>
                    ...
                    magni dolores eos designer heresm qui
                  </p>
                </div>
              </div>
              <div className="col-4">
              ...
              <div className="col-6">
                <div className="aboutMe__div__img">
                  <img
                    ...
                    alt=""
                  />
                  <div className="aboutMe__div__text">
                    <i class="fa-solid fa-chart-pie"></i>
                    <div className="aboutMe__div__text__content">
...
export default Service_aboutMe_innovation;
